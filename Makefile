...
binaries:
	...
	go build -o gobin/post-merge/go_after_hook/main post-merge/go_after_hook/main.go
	go build -o gobin/post-merge/js_after_hook/main post-merge/js_after_hook/main.go
	go build -o gobin/pre-commit/debugger-checker/main pre-commit/debugger-checker/main.go
